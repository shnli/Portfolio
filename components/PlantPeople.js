...
export default function PathSync() {
  ...
  return (
    <div className='flex justify-center font-Mont'>
        ...
        <div className='flex flex-col px-8 lg:px-48 gap-8 '>

            <div className=''>
                <div className='flex lg:flex-row flex-col lg:py-12'>
                    <div className='flex text-center lg:text-start items-center lg:text-[60px] text-[25px] font-CG font-bold pb-4 text-green-900'>
                        Bridging the Gap Between Nurseries & Plant Owners
                    </div>
                    <div class=" flex align-center justify-center lg:max-w-[700px] max-w-[500px]">
                        <img src="/plantpeople/ppl.png" alt="..." className="lg:flex cursor-pointer rounded align-center"/>
                    </div>
                </div>
                <div className='lg:text-md text-xs pt-4 lg:pt-0'>
            ...
            <div className='flex lg:flex-row flex-col lg:gap-24 gap-4'>
                <div className='flex flex-col gap-4 lg:w-1/2'>
                    ...
                    <div className=''>PathSync is a web application developed to support individuals and organizations that follow a joint design manufacturing model. By integrating project management and analysis functionalities, the program streamlines and brings transparency to the entire collaborative manufacturing process.</div>
                </div>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-4 px-8'>
                    ...
                    <div className='lg:text-xl'>
                        From there, I gathered a collection of <span className='text-blue-500'>Key Features</span>:
            ...
            <div className='flex flex-col gap-4 pb-24'>
                ...
                <ul className='lg:text-xl list-disc pl-8 px-8'>
