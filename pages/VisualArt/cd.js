            ...
            <div className="lg:flex align-center items-start justify-center w-screen space-x-12 lg:px-64 md:px-24 px-12 h-auto">
              <div className="lg:py-20 py-12">
                <img
                  ...
                  src="/mw2.png"
                  alt="megaworld"
                  className="lg:max-w-md w-sm"
                ></img>
                <div className="py-8 font-jost md:text-lg sm:text-sm text-darkgreen text-opacity-70">
                  Welcome to MEGAWORLD, my colorful hobby universe revolving
                  around fantasy and adventure. Here, you&apos;ll find heroes
                  brimming with personality, action shots, and most of all, cool
                  art. Enjoy your stay!
                </div>
                <div className="mx-4">
                  <img
