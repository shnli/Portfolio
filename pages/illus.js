              ...
              {/* <div class="relative flex items-center justify-center h-screen overflow-hidden">
                ...
                <div className='lg:mx-12'>
                  <div className='flex justify-center w-auto h-auto lg:space-x-8 gap-4'>
                    <img src='/a28.png' alt='megaworld' className='lg:w-2/12 lg:h-5/6 w-3/12 h-5/6'></img>
                    <img src='/a23.jpg' alt='megaworld' className='lg:w-2/12 lg:h-5/6 w-3/12 h-5/6'></img>
                    <img src='/a22.png' alt='megaworld' className='lg:w-2/12 lg:h-5/6 w-3/12 h-5/6'></img>
                    <img src='/a27.png' alt='megaworld' className='w-2/12 h-5/6 hidden lg:flex'></img>
                  </div>
                </div>  
                ...
                <div className='lg:mx-12'>
                  <div className='flex justify-center w-auto h-auto lg:space-x-8 gap-4'>
                    ...
                    <img src='/a27.png' alt='megaworld' className='w-3/12 lg:hidden flex'></img>
                ...
                <div className='space-y-12'>
                  ...
                  <img class="flex object-contain justify-center lg:px-64 px-12" src="/a1.png" alt="image description"/>
                  <img class="flex object-contain justify-center lg:px-64 px-12" src="/a2.png" alt="image description"/>
                  <img class="flex object-contain justify-center lg:px-64 px-12" src="/a3.png" alt="image description"/>
                </div>
