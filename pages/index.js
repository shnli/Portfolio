        ...
        <section>
          <div className="flex justify-center pt-4 items-center w-screen ">
            <div class='flex flex-col md:px-32 px-8 justify-center md:gap-4 gap-6 items-center w-screen'>
              <h1 className='flex md:text-[70px] font-LS font-medium text-black text-[36px]'>Hi, I&apos;m Li. </h1>
              <div className='justify-center flex md:text-[32px] font-LS font-medium text-black text-[16px]'>Wanna know more? Choose a character.</div>
              <div className='justify-center flex md:text-lg font-LS font-medium opacity-30 text-sm'>Or... just click&nbsp;  <div className='underline'><Link href={"/about"}> here</Link></div></div>
