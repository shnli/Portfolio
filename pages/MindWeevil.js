        ...
        <header className='flex items-center justify-between py-6 px-20'>
          <div className = 'flex'>
            ...
            <p className= ''>
              <Link href="/">
              <button> 
                <img src="/untitledartwork29.png" alt="..." class="h-10 w-20 rounded align-middle" />
              </button>
              </Link>
            </p>
          </div>
            ...
            <div className='space-y-24'>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-4'>
                  ...
                  <img class="flex object-contain justify-center px-96" src="/mwe8.png" alt="image description"/>
                </div>
