              ...
              <div className='flex justify-start flex-center md:flex-row flex-col md:space-x-12 space-y-12'>
                ...
                <div className='space-y-2 px-4 mx-8'>
                  ...
                  <div className='flex items-center space-x-2'>
                    ...
                    <Link className='text-md font-jost text-darkgreen underline' href="https://drive.google.com/file/d/1EgREIgyvSA-4ARAcKiJm4KJJIZFcg8b-/view?usp=sharing" target="_blank" rel='noreferrer noopener'class= 'text-darkgreen text-opacity-70 underline' > resumé</Link>
                  </div>
                </div>
              </div>   
              {/* stars */}
