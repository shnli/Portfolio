              ...
              <div className='flex justify-start items-center space-x-12'>
                ...
                <div className='space-y-2 px-4'>
                  ...
                  <div class ='flex items-center space-x-2'>
                    ...
                    <a className='text-md font-jost text-darkgreen underline' href="https://www.linkedin.com/in/lishen123" target="_blank" rel='noreferrer noopener' class= 'text-darkgreen text-opacity-70 underline'>linkedIn</a>
                  </div>
                  ...
                  <div class ='flex items-center space-x-2'>
                    ...
                    <a className='text-md font-jost text-darkgreen underline' href="https://www.instagram.com/p7rtial/?hl=en" target="_blank" rel='noreferrer noopener' class= 'text-darkgreen text-opacity-70 underline'>instagram</a>
                  </div>
                  ...
                  <div className='flex items-center space-x-2'>
                    ...
                    <a className='text-md font-jost text-darkgreen underline' href="https://drive.google.com/file/d/1_r_lrL8Ci1-VJ02J_BDbYHAf6d5ASHFQ/view?usp=share_link" target="_blank" rel='noreferrer noopener'class= 'text-darkgreen text-opacity-70 underline'> resumé</a>
                  </div>
                </div>
              </div>   
              {/* stars */}
