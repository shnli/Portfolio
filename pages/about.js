                  ...
                  <div className='font-Mont text-lg w-auto space-y-2 text-darkgreen text-opacity-70'>
                    ...
                    <div className='space-y-2 px-4 mx-8 text-sm'>
                      ...
                      <div className='flex items-center space-x-2'>
                        ...
                        <Link className='text-md font-Mont text-darkgreen underline' href="https://drive.google.com/file/d/186hQTt1T5OpWyo7q0x-DugtqEh-prMP5/view?usp=sharing" target="_blank" rel='noreferrer noopener'class= 'text-darkgreen text-opacity-70 underline' > resumé</Link>
                      </div>
                    </div>
